...
public interface DatatxtProperties {
    ...
    public static final String NAMESPACE = "eu.spaziodati.datatxt.stanbol.enhancer.engines";
    ...
    public static final String DATATXT_NEX_URL = NAMESPACE + ".url";
    ...
    public static final String DATATXT_APP_ID = NAMESPACE + ".app_id";
    ...
    public static final String DATATXT_MIN_CONFIDENCE = NAMESPACE + ".min_confidence";
    ...
    public static final String DATATXT_MIN_LENGTH = NAMESPACE + ".min_length";
    ...
    public static final String DATATXT_EXTRA_TYPES = NAMESPACE + ".extra_types";
    ...
    public static final String DATATXT_COUNTRY = NAMESPACE + ".country";
    ...
    public static final String DATATXT_CUSTOM_SPOTS = NAMESPACE + ".custom_spots";
